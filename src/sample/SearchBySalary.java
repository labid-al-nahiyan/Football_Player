...
public class SearchBySalary implements Initializable {
    private Main main;
    ...
    public void Submit(ActionEvent event){
        ...
        List<String> searchBySalary;
        searchBySalary = SearchMethod.bySalary(HeightInput, LowerInput, main.player);
        if(!searchBySalary.isEmpty())
            for(String p:searchBySalary){
